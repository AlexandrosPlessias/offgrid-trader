...
export default function App() {
  ...
  const [paperPanelOpen, setPaperPanelOpen] = useState(() => {
    try {
      const stored = localStorage.getItem('paper_panel_open')
      if (stored !== null) return stored !== 'false'   // honour explicit user preference
      return window.innerWidth > 768                   // no preference: open on desktop, closed on mobile
    } catch { return true }
  })
