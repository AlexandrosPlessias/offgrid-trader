# MarketSage — Documentation Index

> Quick links to each reference page. For first-time setup see [SETUP.md](../../SETUP.md); for day-to-day commands see [USAGE.md](../../USAGE.md).
